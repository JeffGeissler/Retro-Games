...
The original roadmap was documentation-only. The subsequent Tic Tac Toe increment adds a Python application and PySide6 dependency in an isolated python/ directory. Existing platform applications and their build instructions remain separate.
